...
const ExpensesSection = ({ selections, grossSale, grossSaleAfterGST, netSale }) => {
    ...
    const calculatePercentage = (value) => {
        return grossSaleAfterGST > 0 ? ((parseFloat(value) || 0) / grossSaleAfterGST * 100).toFixed(2) + '%' : '0%'
    }
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr style={{
                                ...
                                <td style={{ fontWeight: 'bold' }}>{grossSaleAfterGST > 0 ? ((Math.abs(calculateProfitLoss()) / grossSaleAfterGST * 100).toFixed(2) + '%') : '0%'}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
