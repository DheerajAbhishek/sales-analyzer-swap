...
def lambda_handler(event, context):
    try:
        ...
        trigger_source = data.get("trigger_source", "manual")  # Extract trigger_source, default to manual

        logger.info(f"Batch processing {len(files_to_process)} files with trigger_source: {trigger_source}")
        ...
        for filename in files_to_process:
            ...
            # Pass trigger_source to each file processing lambda
            qparams["trigger_source"] = trigger_source
