...
const GmailIntegrationPanel = () => {
  ...
  const checkGmailIntegration = async () => {
    ...
    try {
      const status = await gmailIntegrationService.isGmailIntegrationReady(
        currentUser.email,
      );
  ...
  const disconnectGmail = async () => {
    ...
    try {
      const result = await gmailIntegrationService.removeGmailTokens(
        currentUser.email,
      );
      ...
      {!integrationStatus.ready && (
        <div className="connection-section">
          <div className="info-box">
            ...
            <p>
              Connect your Gmail account to automatically fetch emails from
              specific senders and download their Excel file attachments (.xlsx,
              .xls, .xlsm, .csv) to your S3 bucket.
              <br />
              <strong>Note:</strong> Only Excel files will be processed. All
              other attachment types will be ignored.
            </p>{" "}
            {integrationStatus.hasTokens && integrationStatus.isExpired && (
              <div className="warning-message">
                Your Gmail tokens have expired. Please reconnect to continue
      ...
      {integrationStatus.ready && (
        <div className="processing-section">
          <div className="info-box">
            ...
            <p>
              Your Gmail account is connected. Emails from{" "}
              <strong>billing@zomato.com</strong> and{" "}
              <strong>payments@swiggy.in</strong> are automatically processed
              after signup.
            </p>
          </div>
          ...
          <div className="email-processor" style={{ display: "none" }}>
            ...
            <div className="process-info">
              <p>
                This will fetch the last 150 emails from the specified sender
                and download only Excel file attachments (.xlsx, .xls, .xlsm,
                .csv) to your S3 bucket. All other file types will be
                automatically ignored. After upload, it will trigger your N8N
                workflow.
              </p>
            </div>{" "}
          ...
          {processing.active && (
            <div className="processing-status">
              <div className="loading-spinner"></div>
              <p>
                Processing Excel files from{" "}
                <strong>{processing.senderEmail}</strong>...
                <br />
                <small>
