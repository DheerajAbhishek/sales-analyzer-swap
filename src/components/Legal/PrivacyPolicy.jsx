        ...
        <div className="legal-document-container">
            <div className="legal-document">
                ...
                <section>
                    ...
                    <p>
                        Swap Dietetics Private Limited ("we," "us," or "our") operates the web platform Restalytics,
                        which provides comprehensive analytics, reporting tools, and automated data processing for
                        restaurant and food-tech businesses.
                    </p>
                    <p>
                        This Privacy Policy explains how we collect, use, and protect information when you access
                        our website, use our services, or sign in using Google OAuth.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <ul>
                        <li>Email content from specific senders (e.g., Zomato, Swiggy, payment processors)</li>
                        <li>Email attachments containing sales reports and analytics data</li>
                        <li>Email metadata (sender, date, subject) for processing automation</li>
                    </ul>
                    <p className="important-note">
                        <strong>Important:</strong> We only access emails relevant to your business analytics.
                        We do not read personal emails or store unnecessary email content.
                    </p>
                ...
                <section>
                    ...
                    <p className="highlight">
                        <strong>We never sell, rent, or trade your personal or business data.</strong>
                    </p>
                </section>
                ...
                <section>
                    ...
                    <ul>
                        ...
                        <li>Business data: Retained as long as necessary for service provision</li>
                        <li>Email processing data: Automatically deleted after analysis completion</li>
                        <li>Backup data: Retained for 30 days for disaster recovery</li>
                    </ul>

                    <h3>4.3 Data Location</h3>
                    <p>
                        Your data is stored on secure AWS servers located in Asia Pacific (Mumbai) region,
                        ensuring compliance with Indian data protection requirements.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        In the event of a merger, acquisition, or sale of assets, user data may be
                ...
                <section>
                    ...
                    <ul>
                        <li>Revoke Gmail access anytime from your Google Account Permissions</li>
                        <li>Control which emails are processed through our platform settings</li>
                ...
                <section>
                    ...
                    <p>
                        Restalytics is not intended for individuals under 18 years of age. We do not
                ...
                <section>
                    ...
                    <p>
                        If you are accessing Restalytics from outside India, please be aware that your
                        information may be transferred to, stored, and processed in India where our servers are located.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        ...
                        or legal requirements. We will notify you of significant changes via email or platform
                        notification. The latest version will always be available at https://www.restalytics.ai/privacy
                    </p>
                </section>
                ...
                <section>
                    ...
                    <div className="contact-info">
                        ...
                        <p><strong>Privacy:</strong> privacy@restalytics.ai</p>
                        <p><strong>General Support:</strong> admin@swapnow.in</p>
                        <p><strong>Data Protection Officer:</strong> dpo@restalytics.ai</p>
