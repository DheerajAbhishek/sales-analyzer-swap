...
def lambda_handler(event, context):
    ...
    Single-user version (no business email path)
    """
    try:
        # Parse input
        ...
        bucket_name = 'my-project-uploadss'
        
        # For single-user, use the standard path structure
            ...
            for page in page_iterator:
                if 'Contents' in page:
                    for obj in page['Contents']:
                        key = obj['Key']
                        # Extract date from filename like: daily-insights/12345/2024-01-15.json
