...
const GoogleSignupForm = ({
  ...
  const handleCancelLink = () => {
    setShowLinkDialog(false);
    setError(
      "Account linking cancelled. Please try with a different email or sign in to your existing account.",
    );
  };
        ...
        <form onSubmit={handleSubmit} className="signup-form">
          ...
          <div className="form-group">
            ...
            <small className="form-help">
              You can use this password to login with your email later
            </small>
          </div>
