    ...
    <div className="legal-document-container">
      <div className="legal-document">
        ...
        <section>
          ...
          <p>
            By accessing, using, or registering for Restalytics, you acknowledge
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              We may modify, update, or discontinue features with reasonable
              notice
            </li>
            <li>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Authorized to represent the business/restaurant for which you're
              using Restalytics
            </li>
          </ul>
        ...
        <section>
          ...
          <p>
            Your account is for your business use only and may not be shared,
            transferred, or used by unauthorized individuals.
          </p>
        </section>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Use the service for unlawful, harmful, or unauthorized purposes
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              Free from confidential third-party information (unless authorized)
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            All content, features, functionality, trademarks, logos, and
            software constituting Restalytics are the exclusive property of Swap
            Dietetics Private Limited and are protected by Indian and
          ...
          <p>
            ...
            license to use Restalytics for your business purposes, subject to
            these Terms.
          </p>

          <h3>6.3 Your Data</h3>
          <p>
            You retain ownership of your business data. By using our service,
            you grant us a limited license to process, analyze, and store your
            data solely to provide our services.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Currently, Restalytics offers free access to core analytics
            features.
          </p>
          ...
          <p>
            You may export your data at any time, regardless of account status.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Your use of Restalytics is also governed by our Privacy Policy,
          ...
          <ul>
            <li>
              Gmail access is optional but required for automated email
              processing
            </li>
            <li>We only access emails relevant to business analytics</li>
            <li>You can revoke Gmail permissions at any time</li>
            <li>
              Processed email data is automatically deleted after analysis
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Processed data will be deleted according to our Privacy Policy
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            Restalytics is provided on an "AS-IS" and "AS-AVAILABLE" basis. We
          ...
          <p>
            To the maximum extent permitted by law, Swap Dietetics Private
          ...
          <p className="highlight">
            ...
            claims related to Restalytics shall not exceed Rs. 10,000 (Ten
            Thousand Indian Rupees).
          </p>

          <h3>10.3 Business Decision Disclaimer</h3>
          <p>
            Restalytics provides analytical tools and insights, but you are
            solely responsible for business decisions based on this information.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            You agree to indemnify and hold Swap Dietetics Private Limited
        ...
        <section>
          ...
          <p>
            Any disputes arising from these Terms or your use of Restalytics
          ...
          <ol>
            <li>
              <strong>Direct Communication:</strong> Contact us first to resolve
              issues amicably
            </li>
            <li>
              <strong>Mediation:</strong> If needed, we'll attempt mediation
              before litigation
            </li>
            <li>
              <strong>Legal Action:</strong> As a last resort, through Hyderabad
              courts only
            </li>
          </ol>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            complete agreement between you and Swap Dietetics Private Limited
            regarding Restalytics.
          </p>
          ...
          <p>
            You may not assign these Terms or your account without our written
        ...
        <section>
          ...
          <div className="contact-info">
            ...
            <p>
              <strong>Legal:</strong> legal@restalytics.ai
            </p>
            <p>
              <strong>General Support:</strong> support@restalytics.ai
            </p>
            <p>
              <strong>Business Inquiries:</strong> business@restalytics.ai
            </p>
            <p>
        ...
        <footer className="legal-footer">
          <p>
            <em>
              These Terms of Service are effective as of November 2025 and
              govern your use of Restalytics.
            </em>
          </p>
        </footer>
      </div>
