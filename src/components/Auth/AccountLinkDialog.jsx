    ...
    <div className="account-link-overlay">
      <div className="account-link-dialog">
        ...
        <div className="account-details">
          <div className="existing-account">
            ...
            <div className="account-info">
              ...
              <p>
                <strong>Restaurant:</strong> {existingUser.restaurantName}
              </p>
              <p>
                <strong>Sign-in Method:</strong>{" "}
                {existingUser.authMethod === "traditional"
                  ? "Email & Password"
                  : "Google"}
              </p>
            </div>
          ...
          <div className="google-account">
            ...
            <div className="account-info">
              <div className="google-profile">
                ...
                <div>
                  <p>
                    <strong>Name:</strong> {googleUserData.name}
                  </p>
                  <p>
        ...
        <div className="link-explanation">
          ...
          <ul>
            <li>
              You'll be able to sign in with both email/password and Google
            </li>
