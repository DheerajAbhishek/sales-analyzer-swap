...
const Hero = ({ user, onGoToDashboard, onConnectGmail }) => {
    ...
    return (
        <section className="hero-new">
            <div className="hero-container-new">
                ...
                >
                    <h1 className="hero-title-new">
                        Are Your <span className='swiggy'>Swiggy</span> & <span className='zomato'>Zomato</span> Discounts <span className="hero-highlight-new">Eating Your Profits?</span>
                    </h1>
                    ...
                    <p className="hero-description-new">
                        Connect your Gmail once — instantly see if your ad spends and discount budgets are under control. <strong>No manual uploads.</strong>
                    </p>
                    ...
                    <div className="platform-showcase">
                        ...
                        <motion.div
                            ...
                            transition={{
                                ...
                                scale: { duration: 3.5, repeat: Infinity, ease: "easeInOut", delay: 0.3 },
                                y: { duration: 5, repeat: Infinity, ease: "easeInOut", delay: 0.6 },
                                x: { duration: 4, repeat: Infinity, ease: "easeInOut", delay: 0.1 }
                            }}
                        >
            ...
            >
                <p className="demo-text">Not sure where to start? Book a free demo with our team</p>
                <a
                    href="https://calendly.com/dheerajabhishek111/30min"
                    target="_blank"
                    rel="noopener noreferrer"
