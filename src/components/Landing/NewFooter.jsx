  ...
  return (
    <footer className="new-landing-footer">
      <div className="footer-container-new">
        ...
        <div className="footer-links-section">
          ...
          <div className="footer-links-column">
            ...
            <ul>
              <li>
                <a href="mailto:support@restalytics.ai">
                  support@restalytics.ai
                </a>
              </li>
              <li>
                <a href="mailto:support@restalytics.ai">Support</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="footer-bottom">
        <p>
          &copy; {new Date().getFullYear()} Restalytics. All rights reserved.
        </p>
      </div>
    </footer>
  );
